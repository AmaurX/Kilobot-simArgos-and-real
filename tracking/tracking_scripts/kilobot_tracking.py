...
# in RGB!
green_min = [40, 200, 40]
green_max = [210, 255, 210]

purple_min = [75, 10, 75]
purple_max = [255, 60, 255]
...
def main():
    ...
    while True:
        ...
        for kilo in Kilobot.kilobot_list:
            ...
            cv2.circle(frame, (kilo.current_position[0],
                               kilo.current_position[1]), kilobot_radius, colors[status], max(1, 3 + certainty - kilo.update_coef))
            # if(status > 0):
            #     cv2.circle(frame, (kilo.current_position[0],
