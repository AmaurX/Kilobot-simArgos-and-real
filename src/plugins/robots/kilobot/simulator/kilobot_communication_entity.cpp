...
CKilobotCommunicationEntity::CKilobotCommunicationEntity(CComposableEntity *pc_parent,
                                                         ...
                                                         Real f_range,
                                                         SAnchor &s_anchor,
                                                         CEmbodiedEntity &c_entity_body) : CPositionalEntity(pc_parent,
                                                                                                             str_id),
                                                                                           m_psAnchor(&s_anchor),
                                                                                           m_fTxRange(f_range),
...
CKilobotCommunicationEntityGridCellUpdater::CKilobotCommunicationEntityGridCellUpdater(CGrid<CKilobotCommunicationEntity> &c_grid) : m_cGrid(c_grid) {}
...
CKilobotCommunicationEntityGridEntityUpdater::CKilobotCommunicationEntityGridEntityUpdater(CGrid<CKilobotCommunicationEntity> &c_grid) : m_cGrid(c_grid),
